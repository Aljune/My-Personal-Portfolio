<template>
    <div class="container-fluid">
        <div class="row d-flex  part-progress-bar ">
                ...
                <div class="row gap-3">
                    ...
                    <div class="col-12">
                        <div class="text-end">
                            ...
                            <div class="progress">
                                <div class="progress-bar bg-success" role="progressbar" style="width: 80%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="80"></div>
                            </div>
                        </div>
                    </div>
                     <div class="col-12">
           ...
           <div class="col-md-6 col-12 p-bar-2">
                <div class="row gap-3">
                    <div class="col-12">
                        <div class="text-end">
                            <h5 class=" text-start text-white">
